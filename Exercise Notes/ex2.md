In this exercise, I learned about comments and how they can be utilized to make your program more readable or "disable" a part your code you may want to keep for later use or testing.
